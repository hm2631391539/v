<template>
  <div class="content">
     ...
     <Hnav arrow="gray" bgColor="transparent" :borderWidth="0"/>
    ...
    <div class="input">
      <!-- <Hinput :label="'账号'" type="text" :value="username" @input="checkUser" /> -->
      <Hinput :label="'账号'" type="text" v-model="username" />
      <Hinput label="密码" type="password" v-model="password" />
    </div>
	
    <div class="footbox">
      <Button text='登 录' @click="show" />
...
<script>
	import Hnav from '../components/h-nav'
	import Hinput from '../components/h-input.vue'
  import Button from '../components/h-button.vue'
  export default {
    name: 'Login',
    props: {},
    data() {
