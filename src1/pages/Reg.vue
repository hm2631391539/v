<template>
  <div class="content">
     <h-nav arrow="gray" bgColor="transparent" :borderWidth="0"/>
    <h1></h1>
    <div class="login-box">
      <p class="lsolid"></p>
      <div class="login">
   ...
   <div>
	  <h-input :label="'账号'" type="text" v-model="username" />
	  <h-input label="密码" type="password" v-model="password" />
   </div>
    <div class="footbox">
...
<script>
	...
	import UcNav from '../components/h-nav'
	import UcInput from '../components/h-input.vue'
