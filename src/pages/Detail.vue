  ...
  <div class="detail">
   ...
   <div class="content" v-if="detail.title">
      <div class="header clear">
		  <!-- 你没有图这个注释了 -->
       <!-- <h2><img width="50" :src="$baseUrl + detail.des" alt=""/></h2> -->
        <p>{{detail.des}}</p> 
    </div>
      <div class="cont">
        <!-- <h3>{{detail.title}}</h3>
         <div class="time"><p>{{detail.time | date}} <span><img src="../assets/img/zan.png" alt=""/></span></p></div> -->
       <div class="text-box" v-html="detail.des"></div>
      </div>
    </div>
  ...
  export default {
    ...
    mounted() {
      axios({
		...
		// url:`/api/goods/home/5e6caded3254c604a16b2b83`,
        // headers:{
        //   token:'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VybmFtZSI6Imx4dyIsIl9pZCI6IjVlNjYxZGQxOTk5NGM2MzI1Y2MzZjNjNCIsImlhdCI6MTU4Mzg4ODAzMywiZXhwIjoxNTgzOTc0NDMzfQ.Z3KldA7-ei7PBPq3dmzNlNz8WreJNxFnYVpBUhd1yeY'
        // }
      }).then(
	    
        res=>{
			
			console.log("详情页的数据",res.data.data)
